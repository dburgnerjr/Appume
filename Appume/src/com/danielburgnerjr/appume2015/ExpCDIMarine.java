...
public class ExpCDIMarine extends Activity {
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_expcdimarine);
	}
	...
	public boolean onKeyDown(int nKeyCode, KeyEvent keEvent) {
		String strBackMessage = "Press Dominion Enterprises to go to the previous screen, ";
		strBackMessage += "SAIC to go to the next screen, ";
