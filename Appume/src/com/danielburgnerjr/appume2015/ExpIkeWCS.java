...
public class ExpIkeWCS extends Activity {
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_expikewcs);
	}
	...
	public void nextPage(View view) {
		Intent intI = new Intent(this, ExpIkeMT.class);
		startActivity(intI);
		finish();
	}
	...
	public boolean onKeyDown(int nKeyCode, KeyEvent keEvent) {
		String strBackMessage = "Press Norfolk State to go to the previous screen, ";
		strBackMessage += "Eisenhower (Technician) to go to the next screen, ";
