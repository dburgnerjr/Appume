...
public class ExpIkePatArm extends Activity {
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_expikepatarm);
	}
	...
	public boolean onKeyDown(int nKeyCode, KeyEvent keEvent) {
		String strBackMessage = "Press Eisenhower (Technician) to go to the previous screen, ";
