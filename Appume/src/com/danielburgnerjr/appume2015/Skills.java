...
public class Skills extends Activity {
	...
	public void mainMenu(View view) {
	 ...
	 public boolean onKeyDown(int nKeyCode, KeyEvent keEvent) {
		String strBackMessage = "Press Certifications to go to the previous screen, ";
		strBackMessage += "Education to go to the next screen or Main Menu to return to main menu.";
