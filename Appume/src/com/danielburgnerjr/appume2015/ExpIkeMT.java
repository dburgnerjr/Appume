...
public class ExpIkeMT extends Activity {
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_expikemt);
	}
	...
	public void nextPage(View view) {
		Intent intI = new Intent(this, ExpIkePatArm.class);
		startActivity(intI);
		finish();
	}
	...
	public boolean onKeyDown(int nKeyCode, KeyEvent keEvent) {
		String strBackMessage = "Press Eisenhower (WCS) to go to the previous screen, ";
		strBackMessage += "Eisenhower (Patrolman/Armorer) to go to the next screen, ";
